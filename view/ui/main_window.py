...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menu_auto_save = QtWidgets.QMenu(self.menu_file)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/files_list.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.menu_auto_save.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/star.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.menu_new_file.setIcon(icon2)
        self.menu_new_file.setObjectName("menu_new_file")
        self.menu_open = QtWidgets.QAction(MainWindow)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/folder.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.menu_open.setIcon(icon3)
        self.menu_open.setObjectName("menu_open")
        self.menu_save = QtWidgets.QAction(MainWindow)
        self.menu_save.setEnabled(False)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/diskette.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.menu_save.setIcon(icon4)
        self.menu_save.setObjectName("menu_save")
        self.menu_save_as = QtWidgets.QAction(MainWindow)
        self.menu_save_as.setEnabled(False)
        self.menu_save_as.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/word.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.menu_export_word.setIcon(icon5)
        self.menu_export_word.setObjectName("menu_export_word")
        self.menu_about = QtWidgets.QAction(MainWindow)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/question.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.menu_about.setIcon(icon6)
        ...
        self.menu_file.addAction(self.menu_auto_save.menuAction())
        self.menu_file.addSeparator()
